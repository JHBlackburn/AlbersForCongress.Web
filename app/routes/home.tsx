...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-[calc(100dvh-76px)] lg:h-full lg:min-h-0 lg:overflow-hidden">
      {/* Hero Section */}
      <div className="text-white relative overflow-hidden min-h-[calc(100dvh-76px)] lg:h-full lg:min-h-0 flex items-start lg:items-center">
        ...
        <div className="relative z-10 w-full min-h-[calc(100dvh-76px)] lg:h-full lg:min-h-0 px-0 pt-2 pb-0 lg:px-[clamp(1.5rem,4vw,5rem)] lg:py-[clamp(0.75rem,2.4vh,2rem)]">
          <div className="h-auto lg:h-full min-h-0 flex flex-col lg:grid lg:grid-cols-[minmax(360px,0.95fr)_minmax(420px,1.35fr)] xl:grid-cols-[minmax(420px,0.95fr)_minmax(520px,1.35fr)] lg:items-center gap-0 lg:gap-[clamp(0.25rem,1.15vw,1.35rem)]">
            ...
            <div className="hidden lg:flex h-full min-h-0 items-center justify-start pt-[clamp(0.25rem,1.2vh,1rem)] pl-[clamp(0.75rem,2vw,2rem)] pb-[clamp(0.5rem,1.5vh,1.25rem)]">
            ...
            <div className="hidden lg:flex h-full min-h-0 flex-col items-start justify-center text-left w-full min-w-0 overflow-hidden pr-[clamp(0.25rem,1vw,1rem)] -ml-[clamp(0.5rem,1.5vw,1.75rem)]">
              <div className="w-full max-w-[min(58vw,920px)] origin-left scale-[clamp(0.72,0.84+0.12vw,1)]">
                <WordScrollAnimation />
              </div>

              <p className="text-white text-[clamp(1.08rem,1.28vw,1.5rem)] mt-[clamp(1rem,2.4vh,2.25rem)] max-w-[min(52vw,840px)] leading-[1.42] xl:leading-[1.55]">
