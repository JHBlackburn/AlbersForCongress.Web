...
export default function HeroImage() {
  return (
    <div className="relative flex h-full min-h-0 w-full items-end justify-center overflow-visible sm:justify-end lg:max-w-[min(48vw,820px)]">
      <div className="relative flex w-screen max-w-none -translate-x-[clamp(0.75rem,4vw,1.5rem)] items-end justify-center sm:w-[min(78vw,34rem)] sm:translate-x-[clamp(1rem,4vw,4.5rem)] md:w-[min(70vw,35rem)] lg:h-[min(calc(100svh-8.1rem),48rem)] lg:w-fit lg:translate-x-0 xl:h-[min(calc(100svh-7.6rem),52rem)]">
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 top-[50%] z-10 w-[clamp(1rem,5vw,2.5rem)] bg-linear-to-r from-[#071f43]/72 via-[#071f43]/28 to-transparent blur-[1px]" />
        <div className="pointer-events-none absolute bottom-0 right-0 top-[50%] z-10 w-[clamp(1rem,5vw,2.5rem)] bg-linear-to-l from-[#071f43]/72 via-[#071f43]/28 to-transparent blur-[1px]" />
