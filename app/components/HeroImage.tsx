  ...
  return (
    <div className="relative inline-block max-h-full">
      ...
      <div className="hidden lg:flex flex-col items-center mt-4">
        <p className="text-white text-[clamp(1.35rem,1.8vw,2rem)] font-semibold mb-3 drop-shadow-lg leading-tight">
          Troy works for YOU
        </p>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-[#FFCC33] hover:bg-[#E8B923] text-blue-900 font-bold text-[clamp(1rem,1.25vw,1.25rem)] px-5 py-2 rounded-lg shadow-xl transition-all duration-200 transform hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-900 whitespace-nowrap"
          >
            Donate
